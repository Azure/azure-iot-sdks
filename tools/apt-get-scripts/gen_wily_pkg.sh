...
repo_dir="debian_release/apt-get-wily"

# Fix up shared-Util
echo "Preparing azure-c-shared-utility wily package"
...
cp debian/changelog-wily debian/changelog
dpkg-buildpackage -us -uc

# Release uAmqp
echo "Preparing azure-uamqp-c wily package"
...
# Release uMqtt
echo "Preparing azure-umqtt-c wily package"
...
# Release Iot-Sdk
echo "Preparing azure-iot-sdk wily package"
