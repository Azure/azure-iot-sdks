...
namespace Microsoft.Azure.Devices.Client
{
    ...
    {
        public static string BufferAlreadyReclaimed = "The buffer has already been reclaimed.";
        public static string ObjectIsReadOnly = "This object is read-only and cannot be modified.";
