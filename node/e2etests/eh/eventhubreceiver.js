...
var debug = require('debug')('eventhubreceiver');
...
EventHubReceiver.prototype.StartReceive = function (startTime) {
  if (startTime !== null) {
    debug('Listening on endpoint ' + this.endpoint + ' start time: ' + startTime);
  }
...
EventHubReceiver.prototype.StartReceiveFromOffset = function (startOffset) {
  if (startOffset !== null) {
    debug('Listening on endpoint ' + this.endpoint + ' start offset: ' + startOffset);
  }
