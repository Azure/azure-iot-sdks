...
describe('MqttTranslateError', function () {
  ...
  it('converts invalid topic error', function () {
    ...
    assert(translateError(Error('Invalid topic')) instanceof errors.FormatError);
  });
  ...
  it('converts no connection to broker error', function () {
    ...
    assert(translateError(Error('No connection to broker')) instanceof errors.NotConnectedError);
  });
  ...
  it('converts unacceptable protocol version error', function () {
    ...
    assert(translateError(Error('Unacceptable protocol version')) instanceof errors.NotImplementedError);
  });
  ...
  it('converts identifier rejected error', function () {
    ...
    assert(translateError(Error('Identifier rejected')) instanceof errors.UnauthorizedError);
  });
  ...
  it('converts server unavilable error', function () {
    ...
    assert(translateError(Error('Server unavailable')) instanceof errors.ServiceUnavailableError);
  });
  ...
  it('converts bad username or password error', function () {
    ...
    assert(translateError(Error('Bad username or password')) instanceof errors.UnauthorizedError);
  });
  ...
  it('converts not authorized error', function () {
    ...
    assert(translateError(Error('Not authorized')) instanceof errors.UnauthorizedError);
  });
  ...
  it('converts unrecognized packet type error', function () {
    ...
    assert(translateError(Error('unrecognized packet type')) instanceof errors.InternalServerError);
  });
  ...
  it('returns generic error when strings dont match', function () {
    ...
    assert(translateError(Error('Zuul')) instanceof Error);
  });
});
