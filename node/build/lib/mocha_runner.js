...
(function() {
	...
	exports.runTests = function runTests(options, success, failure) {
		...
		//   The issue is this: during test execution, if an exception is thrown inside of a callback (and keep
        // in mind that assertions throw exceptions), there's no way for Mocha to catch that exception.
