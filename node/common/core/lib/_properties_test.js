...
var IotProperties = require('./properties.js');

var propertyNum = 10;

describe('properties', function () {
    describe('#add', function () {
        /* Test_SRS_NODE_IOTHUB_PROPERTIES_07_003: [The getItem function shall return a string representation of the body of the message.] */
        /* Test_SRS_NODE_IOTHUB_PROPERTIES_07_002: [Properties.Count shall return the number of items in the Properties map.] */
        it('adds properties to the collection', function () {
            ...
            for (i = 0; i < properties.count(); i++) {
                keyItem = "iothub-app-itemKey"+(i+1);
                valueItem = "itemValue"+(i+1);
        ...
        /* Test_SRS_NODE_IOTHUB_PROPERTIES_07_004: [If itemKey contains any of the reserved key names then the add function will return false] */
    ...
    /* Test_SRS_NODE_IOTHUB_PROPERTIES_07_001: [if the supplied index is greater or equal to zero and less than property map length, then it shall return the property object.] */
