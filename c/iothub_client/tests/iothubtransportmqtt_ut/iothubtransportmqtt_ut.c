...
static void setup_iothubtransportmqtt_dowork_events_mocks(const char* const** ppKeys, const char* const** ppValues, size_t propCount, IOTHUB_MESSAGE_HANDLE msg_handle, bool resend)
{
    STRICT_EXPECTED_CALL(tickcounter_get_current_ms(TEST_COUNTER_HANDLE, IGNORED_PTR_ARG))
        .IgnoreArgument(1)
        .IgnoreArgument(2);
...
static void setup_message_recv_device_method_mocks()
{
    ...
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_PTR_ARG))
        .IgnoreArgument_handle();
    STRICT_EXPECTED_CALL(IoTHubClient_LL_DeviceMethodComplete(TEST_IOTHUB_CLIENT_LL_HANDLE, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_NUM_ARG))
...
TEST_FUNCTION(IoTHubTransportMqtt_DoWork_with_1_event_item_succeeds)
{
    ...
    setup_iothubtransportmqtt_dowork_events_mocks(NULL, NULL, 0, TEST_IOTHUB_MSG_BYTEARRAY, false);
...
TEST_FUNCTION(IoTHubTransportMqtt_DoWork_with_1_event_item_with_properties_succeeds)
{
    ...
    setup_iothubtransportmqtt_dowork_events_mocks((const char* const**)&keys, (const char* const**)&values, propCount, TEST_IOTHUB_MSG_BYTEARRAY, false);
...
TEST_FUNCTION(IoTHubTransportMqtt_DoWork_resend_message_succeeds)
{
    ...
    setup_iothubtransportmqtt_dowork_events_mocks(NULL, NULL, 0, TEST_IOTHUB_MSG_STRING, true);
...
/* Test_SRS_IOTHUB_MQTT_TRANSPORT_07_055: [ IoTHubTransportMqtt_DoWork shall send a device twin get property message upon successfully retrieving a SUBACK on device twin topics. ] */
TEST_FUNCTION(IoTHubTransportMqtt_DoWork_device_twin_resend_message_succeeds)
{
    // arrange
    IOTHUBTRANSPORT_CONFIG config = { 0 };
    SetupIothubTransportConfig(&config, TEST_DEVICE_ID, TEST_DEVICE_KEY, TEST_IOTHUB_NAME, TEST_IOTHUB_SUFFIX, TEST_PROTOCOL_GATEWAY_HOSTNAME);
...
TEST_FUNCTION(IoTHubTransportMqtt_DoWork_with_1_event_item_STRING_type_succeeds)
{
    ...
    setup_iothubtransportmqtt_dowork_events_mocks(NULL, NULL, 0, TEST_IOTHUB_MSG_STRING, false);
...
TEST_FUNCTION(IoTHubTransportMqtt_Subscribe_DeviceTwin_Succeed)
{
    // arrange
    CONNECT_ACK connack ={ true, CONNECTION_ACCEPTED };
    IOTHUBTRANSPORT_CONFIG config ={ 0 };
...
/* Tests_SRS_IOTHUB_MQTT_TRANSPORT_07_054: [ IoTHubTransportMqtt_DoWork shall subscribe to the Notification and get_state Topics if they are defined. ] */
TEST_FUNCTION(IoTHubTransportMqtt_Subscribe_DeviceTwin_DoWork_2nd_fails)
{
    // arrange
    int negativeTestsInitResult = umock_c_negative_tests_init();
    ASSERT_ARE_EQUAL(int, 0, negativeTestsInitResult);
...
/* Tests_SRS_IOTHUB_MQTT_TRANSPORT_07_045: [If 'subscribe_state' is set to IOTHUB_DEVICE_TWIN_NOTIFICATION_STATE then IoTHubTransportMqtt_Subscribe_DeviceTwin shall construct the string $iothub/twin/PATCH/properties/desired] */
/* Tests_SRS_IOTHUB_MQTT_TRANSPORT_07_047: [On success IoTHubTransportMqtt_Subscribe_DeviceTwin shall return 0.] */
TEST_FUNCTION(IoTHubTransportMqtt_Subscribe_DeviceTwin_notify_Succeed)
{
    // arrange
    CONNECT_ACK connack ={ true, CONNECTION_ACCEPTED };
    IOTHUBTRANSPORT_CONFIG config ={ 0 };
...
TEST_FUNCTION(IoTHubTransportMqtt_Subscribe_DeviceTwin_handle_NULL_fail)
{
    // arrange
    umock_c_reset_all_calls();
...
/* Tests_SRS_IOTHUB_MQTT_TRANSPORT_07_043: [If the subscribe_state has been previously subscribed IoTHubTransportMqtt_Subscribe_DeviceTwin shall return a non-zero value.] */
TEST_FUNCTION(IoTHubTransportMqtt_Subscribe_DeviceTwin_fail)
{
    // arrange
    int negativeTestsInitResult = umock_c_negative_tests_init();
    ASSERT_ARE_EQUAL(int, 0, negativeTestsInitResult);
...
/* Tests_SRS_IOTHUB_MQTT_TRANSPORT_07_043: [If the subscribe_state has been previously subscribed IoTHubTransportMqtt_Subscribe_DeviceTwin shall return a non-zero value.] */
TEST_FUNCTION(IoTHubTransportMqtt_Subscribe_DeviceTwin_notify_fail)
{
    // arrange
    int negativeTestsInitResult = umock_c_negative_tests_init();
    ASSERT_ARE_EQUAL(int, 0, negativeTestsInitResult);
...
/*Tests_SRS_IOTHUB_MQTT_TRANSPORT_12_003: [ IoTHubTransportMqtt_Subscribe_DeviceMethod shall set the signaling flag for DEVICE_METHOD topic for the receiver's topic list. ]*/
/*Tests_SRS_IOTHUB_MQTT_TRANSPORT_12_004: [ IoTHubTransportMqtt_Subscribe_DeviceMethod shall construct the DEVICE_METHOD topic string for subscribe. ]*/
/*Tests_SRS_IOTHUB_MQTT_TRANSPORT_12_005: [ IoTHubTransportMqtt_Subscribe_DeviceMethod shall schedule the send of the subscription. ]*/
/*Tests_SRS_IOTHUB_MQTT_TRANSPORT_12_007: [ On success IoTHubTransportMqtt_Subscribe_DeviceMethod shall return 0. ]*/
TEST_FUNCTION(IoTHubTransportMqtt_Subscribe_DeviceMethod_Succeed)
{
    // arrange
    CONNECT_ACK connack = { true, CONNECTION_ACCEPTED };
    IOTHUBTRANSPORT_CONFIG config = { 0 };
...
/*Tests_SRS_IOTHUB_MQTT_TRANSPORT_12_001: [ If the parameter 'handle' is NULL than IoTHubTransportMqtt_Subscribe_DeviceMethod shall return a non-zero value. ]*/
TEST_FUNCTION(IoTHubTransportMqtt_Subscribe_DeviceMethod_handle_NULL_fail)
{
    // arrange
    umock_c_reset_all_calls();

    // act
    int result = IoTHubTransportMqtt_Subscribe_DeviceMethod(NULL);
...
/*Tests_SRS_IOTHUB_MQTT_TRANSPORT_12_006: [ Upon failure IoTHubTransportMqtt_Subscribe_DeviceMethod shall return a non-zero value. ]*/
TEST_FUNCTION(IoTHubTransportMqtt_Subscribe_DeviceMethod_fail)
{
    // arrange
    int negativeTestsInitResult = umock_c_negative_tests_init();
    ASSERT_ARE_EQUAL(int, 0, negativeTestsInitResult);
    ...
    for (size_t index = 0; index < count; index++)
    {
        ...
        char tmp_msg[64];
        sprintf(tmp_msg, "IoTHubTransportMqtt_Subscribe_DeviceMethod failure in test %zu/%zu", index, count);
...
/*Tests_SRS_IOTHUB_MQTT_TRANSPORT_12_008: [ If the parameter 'handle' is NULL than IoTHubTransportMqtt_Unsubscribe_DeviceMethod shall do nothing and return. ]*/
/*Tests_SRS_IOTHUB_MQTT_TRANSPORT_12_009: [ If the MQTT transport has not been subscribed to DEVICE_METHOD topic IoTHubTransportMqtt_Unsubscribe_DeviceMethod shall do nothing and return. ]*/
/*Tests_SRS_IOTHUB_MQTT_TRANSPORT_12_010: [ IoTHubTransportMqtt_Unsubscribe_DeviceMethod shall construct the DEVICE_METHOD topic string for unsubscribe. ]*/
/*Tests_SRS_IOTHUB_MQTT_TRANSPORT_12_011: [ IoTHubTransportMqtt_Unsubscribe_DeviceMethod shall send the unsubscribe. ]*/
/*Tests_SRS_IOTHUB_MQTT_TRANSPORT_12_012: [ IoTHubTransportMqtt_Unsubscribe_DeviceMethod shall removes the signaling flag for DEVICE_METHOD topic from the receiver's topic list. ]*/
TEST_FUNCTION(IoTHubTransportMqtt_Unsubscribe_DeviceMethod_handle_OK)
{
    // arrange
    CONNECT_ACK connack = { true, CONNECTION_ACCEPTED };
    IOTHUBTRANSPORT_CONFIG config = { 0 };
    ...
    TRANSPORT_LL_HANDLE handle = IoTHubTransportMqtt_Create(&config);
    IoTHubTransportMqtt_Subscribe_DeviceMethod(handle);
...
TEST_FUNCTION(IoTHubTransportMqtt_Unsubscribe_DeviceMethod_handle_null)
{
    // arrange
    umock_c_reset_all_calls();

    // act
    IoTHubTransportMqtt_Unsubscribe_DeviceMethod(NULL);
...
TEST_FUNCTION(IoTHubTransportMqtt_Unsubscribe_DeviceMethod_negative_cases)
{
    // arrange
    CONNECT_ACK connack = { true, CONNECTION_ACCEPTED };
    IOTHUBTRANSPORT_CONFIG config = { 0 };
...
TEST_FUNCTION(IoTHubTransportMqtt_ProcessItem_Succeed)
{
    // arrange
    IOTHUBTRANSPORT_CONFIG config = { 0 };
    SetupIothubTransportConfig(&config, TEST_DEVICE_ID, TEST_DEVICE_KEY, TEST_IOTHUB_NAME, TEST_IOTHUB_SUFFIX, TEST_PROTOCOL_GATEWAY_HOSTNAME);
...
/* Tests_SRS_IOTHUBCLIENT_LL_07_001: [ If handle or iothub_item are NULL then IoTHubTransportMqtt_ProcessItem shall return IOTHUB_PROCESS_ERROR.]*/
TEST_FUNCTION(IoTHubTransportMqtt_ProcessItem_iothub_item_NULL_fail)
{
    // arrange
    IOTHUBTRANSPORT_CONFIG config = { 0 };
    SetupIothubTransportConfig(&config, TEST_DEVICE_ID, TEST_DEVICE_KEY, TEST_IOTHUB_NAME, TEST_IOTHUB_SUFFIX, TEST_PROTOCOL_GATEWAY_HOSTNAME);
    ...
    // act
    IOTHUB_PROCESS_ITEM_RESULT result_item = IoTHubTransportMqtt_ProcessItem(handle, IOTHUB_TYPE_DEVICE_TWIN, NULL);
...
/* Tests_SRS_IOTHUBCLIENT_LL_07_001: [ If handle or iothub_item are NULL then IoTHubTransportMqtt_ProcessItem shall return IOTHUB_PROCESS_ERROR.]*/
TEST_FUNCTION(IoTHubTransportMqtt_ProcessItem_NULL_handle_fail)
{
    // arrange
...
/* Tests_SRS_IOTHUBCLIENT_LL_07_002: [ If the mqtt is not ready to publish messages IoTHubTransportMqtt_ProcessItem shall return IOTHUB_PROCESS_NOT_CONNECTED.]*/
TEST_FUNCTION(IoTHubTransportMqtt_ProcessItem_not_connected_Succeed)
{
    // arrange
    IOTHUBTRANSPORT_CONFIG config = { 0 };
    SetupIothubTransportConfig(&config, TEST_DEVICE_ID, TEST_DEVICE_KEY, TEST_IOTHUB_NAME, TEST_IOTHUB_SUFFIX, TEST_PROTOCOL_GATEWAY_HOSTNAME);
...
/* Tests_SRS_IOTHUBCLIENT_LL_07_006: [ If the item_type is not a supported type IoTHubTransportMqtt_ProcessItem shall return IOTHUB_PROCESS_CONTINUE.] */
TEST_FUNCTION(IoTHubTransportMqtt_ProcessItem_continue_Succeed)
{
    // arrange
    IOTHUBTRANSPORT_CONFIG config ={ 0 };
    SetupIothubTransportConfig(&config, TEST_DEVICE_ID, TEST_DEVICE_KEY, TEST_IOTHUB_NAME, TEST_IOTHUB_SUFFIX, TEST_PROTOCOL_GATEWAY_HOSTNAME);
...
/* Tests_SRS_IOTHUBCLIENT_LL_07_004: [ If any errors are encountered IoTHubTransportMqtt_ProcessItem shall return IOTHUB_PROCESS_ERROR. ]*/
TEST_FUNCTION(IoTHubTransportMqtt_ProcessItem_fail)
{
    // arrange
    int negativeTestsInitResult = umock_c_negative_tests_init();
    ASSERT_ARE_EQUAL(int, 0, negativeTestsInitResult);
