...
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_010: [ `IoTHubTransportAMQP_Register` shall create a new iothubtransportamqp_methods instance by calling `iothubtransportamqp_methods_create` while passing to it the the fully qualified domain name and the device Id. ]*/
TEST_FUNCTION(IoTHubTransportAMQP_Register_creates_a_new_methods_handler)
{
    // arrange
    TRANSPORT_PROVIDER* transport_interface = (TRANSPORT_PROVIDER*)AMQP_Protocol();
    ...
    handle = transport_interface->IoTHubTransport_Create(&config);
    umock_c_reset_all_calls();
    ...
    // act
    device_handle = transport_interface->IoTHubTransport_Register(handle, &device_config, TEST_IOTHUB_CLIENT_LL_HANDLE, &waitingToSend);
    ...
    // cleanup
    transport_interface->IoTHubTransport_Destroy(handle);
}

/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_011: [ If `iothubtransportamqp_methods_create` fails, `IoTHubTransportAMQP_Register` shall fail and return NULL. ]*/
TEST_FUNCTION(when_creating_the_methods_handler_fails_then_IoTHubTransportAMQP_Register_fails)
{
    // arrange
    TRANSPORT_PROVIDER* transport_interface = (TRANSPORT_PROVIDER*)AMQP_Protocol();
...
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_012: [ `IoTHubTransportAMQP_Unregister` shall destroy the C2D methods handler by calling `iothubtransportamqp_methods_destroy`. ]*/
TEST_FUNCTION(IoTHubTransportAMQP_Unregister_destroys_the_methods_handler)
{
    // arrange
    TRANSPORT_PROVIDER* transport_interface = (TRANSPORT_PROVIDER*)AMQP_Protocol();
    ...
    // act
    transport_interface->IoTHubTransport_Unregister(device_handle);
...
TEST_FUNCTION(IoTHubTransportAMQP_Subscribe_DeviceMethod_with_NULL_handle_fails)
{
	...
	// act
	result = transport_interface->IoTHubTransport_Subscribe_DeviceMethod(NULL);
...
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_026: [ `IoTHubTransportAMQP_Subscribe_DeviceMethod` shall remember that a subscribe is to be performed in the next call to DoWork and on success it shall return 0. ]*/
TEST_FUNCTION(IoTHubTransportAMQP_Subscribe_DeviceMethod_with_valid_handle_succeeds)
{
    // arrange
    TRANSPORT_PROVIDER* transport_interface = (TRANSPORT_PROVIDER*)AMQP_Protocol();
    int result;
    ...
    // act
    result = transport_interface->IoTHubTransport_Subscribe_DeviceMethod(device_handle);
...
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_026: [ `IoTHubTransportAMQP_Subscribe_DeviceMethod` shall remember that a subscribe is to be performed in the next call to DoWork and on success it shall return 0. ]*/
TEST_FUNCTION(IoTHubTransportAMQP_Subscribe_After_Subscribe_succeeds)
{
	// arrange
	TRANSPORT_PROVIDER* transport_interface = (TRANSPORT_PROVIDER*)AMQP_Protocol();
	int result;
	...
	handle = transport_interface->IoTHubTransport_Create(&config);
	device_handle = transport_interface->IoTHubTransport_Register(handle, &device_config, TEST_IOTHUB_CLIENT_LL_HANDLE, &waitingToSend);
	(void)transport_interface->IoTHubTransport_Subscribe_DeviceMethod(device_handle);
	umock_c_reset_all_calls();
...
TEST_FUNCTION(IoTHubTransportAMQP_Unsubscribe_With_NULL_handle_does_nothing)
{
	// arrange
	TRANSPORT_PROVIDER* transport_interface = (TRANSPORT_PROVIDER*)AMQP_Protocol();
...
TEST_FUNCTION(IoTHubTransportAMQP_Unsubscribe_unsubscribes_from_receiving_methods)
{
	// arrange
	TRANSPORT_PROVIDER* transport_interface = (TRANSPORT_PROVIDER*)AMQP_Protocol();
	...
	// act
	transport_interface->IoTHubTransport_Unsubscribe_DeviceMethod(device_handle);
...
TEST_FUNCTION(IoTHubTransportAMQP_Unsubscribe_without_subscribe_does_nothing)
{
	// arrange
	TRANSPORT_PROVIDER* transport_interface = (TRANSPORT_PROVIDER*)AMQP_Protocol();
...
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_024: [ If the device authentication status is AUTHENTICATION_STATUS_OK and `IoTHubTransportAMQP_Subscribe_DeviceMethod` was called to register for methods, `IoTHubTransportAMQP_DoWork` shall call `iothubtransportamqp_methods_subscribe`. ]*/
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_027: [ The current session handle shall be passed to `iothubtransportamqp_methods_subscribe`. ]*/
TEST_FUNCTION(IoTHubTransportAMQP_DoWork_subscribes_for_methods)
{
	// arrange
	TRANSPORT_PROVIDER* transport_interface = (TRANSPORT_PROVIDER*)AMQP_Protocol();
	...
	// act
	transport_interface->IoTHubTransport_DoWork(handle, TEST_IOTHUB_CLIENT_LL_HANDLE);
...
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_024: [ If the device authentication status is AUTHENTICATION_STATUS_OK and `IoTHubTransportAMQP_Subscribe_DeviceMethod` was called to register for methods, `IoTHubTransportAMQP_DoWork` shall call `iothubtransportamqp_methods_subscribe`. ]*/
TEST_FUNCTION(IoTHubTransportAMQP_DoWork_does_not_subscribe_if_SubScribe_for_methods_was_not_Called_by_the_user)
{
    // arrange
    TRANSPORT_PROVIDER* transport_interface = (TRANSPORT_PROVIDER*)AMQP_Protocol();
...
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_031: [ `iothubtransportamqp_methods_subscribe` shall only be called once (subsequent DoWork calls shall not call it if already subscribed). ]*/
TEST_FUNCTION(IoTHubTransportAMQP_DoWork_does_not_subscribe_if_already_subscribed)
{
    // arrange
    TRANSPORT_PROVIDER* transport_interface = (TRANSPORT_PROVIDER*)AMQP_Protocol();
...
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_028: [ On success, `on_methods_request_received` shall return 0. ]*/
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_016: [ `on_methods_request_received` shall create a BUFFER_HANDLE by calling `BUFFER_new`. ]*/
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_017: [ `on_methods_request_received` shall call the `IoTHubClient_LL_DeviceMethodComplete` passing the method name, request buffer and size and the newly created BUFFER handle. ]*/
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_019: [ `on_methods_request_received` shall call `iothubtransportamqp_methods_respond` passing to it the `method_handle` argument, the response bytes, response size and the status code. ]*/
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_020: [ The response bytes shall be obtained by calling `BUFFER_u_char`. ]*/
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_021: [ The response size shall be obtained by calling `BUFFER_length`. ]*/
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_022: [ The status code shall be the return value of the call to `IoTHubClient_LL_DeviceMethodComplete`. ]*/
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_023: [ After calling `iothubtransportamqp_methods_respond`, the allocated buffer shall be freed by using BUFFER_delete. ]*/
TEST_FUNCTION(on_methods_request_received_responds_to_the_method_request)
{
	...
	device_handle = transport_interface->IoTHubTransport_Register(handle, &device_config, TEST_IOTHUB_CLIENT_LL_HANDLE, &waitingToSend);
	(void)transport_interface->IoTHubTransport_Subscribe_DeviceMethod(device_handle);
    (void)transport_interface->IoTHubTransport_DoWork(handle, TEST_IOTHUB_CLIENT_LL_HANDLE);
	umock_c_reset_all_calls();
...
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_025: [ If creating the buffer fails, on_methods_request_received shall fail and return a non-zero value. ]*/
...
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_029: [ If `iothubtransportamqp_methods_respond` fails, `on_methods_request_received` shall return a non-zero value. ]*/
...
/* Tests_SRS_IOTHUBTRANSPORTAMQP_01_030: [ `on_methods_error` shall do nothing. ]*/
