...
#This script updates a fresh Arduino installation with all the dependent
...
#   curl libcurl4-openssl-dev uuid-dev uuid g++ make cmake git
deps="gcc binutils make tar"
repo="git://github.com/Azure/azure-iot-sdks.git"
...
install_proton_from_source ()
{
    ...
    bash c/build_all/linux/build_proton_arduino.sh --install /usr
}
...
install_paho_from_source ()
{
    ...
    bash c/build_all/linux/build_paho_arduino.sh --install /usr
}
