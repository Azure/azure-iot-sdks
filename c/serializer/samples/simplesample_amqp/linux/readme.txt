How to have a running simplesample_amqp on Ubuntu 14.04 LTS
...
9. switch to the folder of the simplesample source code:

cd ../../serializer/samples/simplesample_amqp/
...
12. at this moment, simplesample_amqp executable can be run by
