...
#parameters to cmake
EXTRA_OECMAKE = "-Drun_valgrind:BOOL=OFF -DcompileOption_C:STRING=OFF -Drun_e2e_tests:BOOL=OFF -Drun_longhaul_tests=OFF -Duse_amqp:BOOL=OFF -Duse_http:BOOL=OFF -Duse_mqtt:BOOL=OFF -Ddont_use_uploadtoblob:BOOL=ON -Dskip_unittests:BOOL=ON"
