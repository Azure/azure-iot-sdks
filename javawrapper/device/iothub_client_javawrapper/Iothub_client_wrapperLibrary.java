...
public interface Iothub_client_wrapperLibrary extends Library{
	 ...
	 */
	public MAP_HANDLE Map_Create(MAP_FILTER_CALLBACK mapFilterFunc);
	 ...
	 */
	public int Map_GetInternals(MAP_HANDLE handle, StringByReference[] keys, StringByReference[] values, size_t count);
	...
	public class StringByReference extends ByReference 
	{
	    ...
	    private static int checkString(String str)
	    {
	    	...
	    	return (str.length() < 4 ? 4 : str.length() + 1);
	    }
