...
/*
 * JNA Wrapper for library iothub_client_python
 */
...
public interface Iothub_client_wrapperLibrary extends Library{
	 ...
	 */
	IOTHUB_CLIENT_HANDLE IoTHubClient_CreateFromConnectionString(String connectionString, Object protocol);
	
	/*
	 * Original signature : IOTHUB_CLIENT_HANDLE DECLDIR IoTHubClient_Create(const IOTHUB_CLIENT_CONFIG*)
	 */
	IOTHUB_CLIENT_HANDLE IoTHubClient_Create(IOTHUB_CLIENT_CONFIG config);
	
	/*
	 * Original signature : IOTHUB_CLIENT_RESULT IoTHubClient_Destroy(IOTHUB_CLIENT_HANDLE)
	 */
	int IoTHubClient_Destroy(Pointer iotHubClientHandle);
	 ...
	 */
	int IoTHubClient_GetSendStatus(Pointer iotHubClientHandle, IntByReference iotHubClientStatus);
	 ...
	 */
	int IoTHubClient_SetMessageCallback(Pointer iotHubClientHandle, IotHubMessageCallback messageCallback, Pointer userContextCallback);
	
	/*
	 * Original signature : IOTHUB_CLIENT_RESULT DECLDIR IoTHubClient_GetLastMessageReceiveTime(IOTHUB_CLIENT_HANDLE, time_t* )
	 */
	int IoTHubClient_GetLastMessageReceiveTime(Pointer iotHubClientHandle, time_t lastMessageReceiveTime);
	
	/*
	 * Original signature : IOTHUB_CLIENT_RESULT IoTHubClient_SetOption(IOTHUB_CLIENT_HANDLE, const char*, const void*)
	 */
	int IoTHubClient_SetOption(Pointer iotHubClientHandle, String optionName, Object value);
	 ...
	 */
	TRANSPORT_HANDLE IoTHubTransportHttp_Create(IOTHUBTRANSPORT_CONFIG config[]);
	 ...
	 */
	void IoTHubTransportHttp_DoWork(TRANSPORT_HANDLE handle, IOTHUB_CLIENT_HANDLE iotHubClientHandle);
	
	/*
	 * Original signature : IOTHUB_CLIENT_RESULT IoTHubTransportHttp_GetSendStatus(TRANSPORT_HANDLE, IOTHUB_CLIENT_STATUS*)
	 */
	int IoTHubTransportHttp_GetSendStatus(TRANSPORT_HANDLE handle, IntByReference iotHubClientStatus);
	
	/*
	 * Original signature : IOTHUB_CLIENT_RESULT IoTHubTransportHttp_SetOption(TRANSPORT_HANDLE, const char*, const void*)
	 */
	int IoTHubTransportHttp_SetOption(TRANSPORT_HANDLE handle, String optionName, Pointer value);
	
	/*
	 * Original signature : void* HTTP_Protocol()
	 */
	Pointer HTTP_Protocol(); 
	 ...
	 */
	IOTHUB_MESSAGE_HANDLE IoTHubMessage_CreateFromString(String source);
	
	/*
	 * Original signature : IOTHUB_MESSAGE_HANDLE IoTHubMessage_CreateFromByteArray(const unsigned char* byteArray, size_t size)
	 */
	IOTHUB_MESSAGE_HANDLE IoTHubMessage_CreateFromByteArray(byte[] byteArray, int size);
	 ...
	 */
	String IoTHubMessage_GetString(IOTHUB_MESSAGE_HANDLE iotHubMessageHandle);
	
	/*
	 * Original signature : IOTHUB_MESSAGE_RESULT IoTHubMessage_GetByteArray(IOTHUB_MESSAGE_HANDLE, const unsigned char**, size_t* )
	 */
	int IoTHubMessage_GetByteArray(IOTHUB_MESSAGE_HANDLE iotHubMessageHandle, PointerByReference buffer, IntByReference size);
	 ...
	 */
	String IoTHubMessage_GetMessageId(IOTHUB_MESSAGE_HANDLE iotHubMessageHandle);
	
	/*
	 * Original signature : IOTHUB_MESSAGE_RESULT IoTHubMessage_SetMessageId(IOTHUB_MESSAGE_HANDLE, const char* )
	 */
	int IoTHubMessage_SetMessageId(IOTHUB_MESSAGE_HANDLE iotHubMessageHandle, String messageId);
	
	/*
	 * Original signature : const char* IoTHubMessage_GetCorrelationId(IOTHUB_MESSAGE_HANDLE )
	 */
	String IoTHubMessage_GetCorrelationId(IOTHUB_MESSAGE_HANDLE iotHubMessageHandle);
	
	/*
	 * Original signature : IOTHUB_MESSAGE_RESULT IoTHubMessage_SetCorrelationId(IOTHUB_MESSAGE_HANDLE, const char* )
	 */
	int IoTHubMessage_SetCorrelationId(IOTHUB_MESSAGE_HANDLE iotHubMessageHandle, String correlationId);
	 ...
	 */
	void Map_Clone(MAP_HANDLE handle);
	
	/*
	 * Original signature : MAP_RESULT Map_Add(MAP_HANDLE , const char* , const char* )
	 */
	int Map_Add(MAP_HANDLE handle, String key, String value);
	
	/*
	 * Original signature : MAP_RESULT Map_AddOrUpdate(MAP_HANDLE, const char*, const char* )
	 */
	int Map_AddOrUpdate(MAP_HANDLE handle, String key, String value);
		
	/*
	 * Original signature : MAP_RESULT Map_Delete(MAP_HANDLE , const char* )
	 */
	int Map_Delete(MAP_HANDLE handle, String key);
	
	/*
	 * Original signature : MAP_RESULT Map_ContainsValue(MAP_HANDLE, const char* , bool* )
	 */
	int Map_ContainsValue(MAP_HANDLE handle, String value, IntByReference valueExists);
	
	/*
	 * Original signature : const char* Map_GetValueFromKey(MAP_HANDLE, const char* )
	 */
	String Map_GetValueFromKey(MAP_HANDLE handle, String key);
	
	/*
	 * Original signature : MAP_RESULT Map_GetInternals(MAP_HANDLE, const char*const**, const char*const**, size_t* )
	 */
	int Map_GetInternals(MAP_HANDLE handle, StringByReference[] keys, StringByReference[] values, size_t count);
	...
	public interface MAP_FILTER_CALLBACK extends Callback {
