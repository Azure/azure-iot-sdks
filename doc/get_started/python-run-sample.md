...
Note: On Windows, you can install the **iothub-client** library package using Pip as described in [Prepare your development environment][lnk-python-devbox-setup].
