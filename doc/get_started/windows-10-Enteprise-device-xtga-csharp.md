...
Run a simple Csharp sample on device-xtga device running Windows 10 Enteprise
===
---
...
This document describes how to connect device-xtga device running Windows 10 Enteprise with Azure IoT SDK. This multi-step process includes:
...
-   [device-xtga][device-link] device.

<a name="PrepareDevice"></a>
# Step 2: Prepare your Device
-   Connect the power adapter, USB Keyborad/Mouse with Avalue [device-xtga][device-link].
