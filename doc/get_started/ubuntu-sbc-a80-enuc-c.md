...
-   Run the sample by issuing following command:
    ...
    **For AMQP protocol:** Run sample iothub_client_sample_amqp
        ...
        ./cmake/iotsdk_linux/iothub_client/samples/iothub_client_sample_amqp/iothub_client_sample_amqp
    ...
    **For HTTP protocol:** Run sample iothub_client_sample_http
 	  ...
 	  **For MQTT protocol:** Run sample iothub_client_sample_mqtt
        ...
        ./cmake/iotsdk_linux/iothub_client/samples/iothub_client_sample_mqtt/iothub_client_sample_mqtt
