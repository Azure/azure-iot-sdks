...
Run a simple csharp sample on MSC Q7-BW device running Windows 10
===
---
...
This document describes how to connect MSC Q7-BW device running Windows 10 with Azure IoT SDK. This multi-step process includes:
