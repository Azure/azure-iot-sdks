...
public class HttpsRequestTest
{
    ...
    // Tests_SRS_SERVICE_SDK_JAJA_HTTPSREQUEST_12_001: [The function shall open a connection with the given URL as the endpoint.]
    @Test
    ...
    // Tests_SRS_SERVICE_SDK_JAJA_HTTPSREQUEST_12_002: [The function shall write the body to the connection.]
    @Test
    ...
    // Tests_SRS_SERVICE_SDK_JAJA_HTTPSREQUEST_12_004: [The function shall use the given HTTPS method (i.e. GET) as the request method.]
    @Test
    ...
    // Tests_SRS_SERVICE_SDK_JAJA_HTTPSREQUEST_12_005: [If an IOException occurs in setting up the HTTPS connection, the function shall throw an IOException.]
    ...
    // Tests_SRS_SERVICE_SDK_JAJA_HTTPSREQUEST_12_008: [The function shall send an HTTPS request as formatted in the constructor.]
    @Test
    ...
    // Tests_SRS_SERVICE_SDK_JAJA_HTTPSREQUEST_12_009: [The function shall return the HTTPS response received, including the status code, body, header fields, and error reason (if any).]
    @Test
    ...
    // Tests_SRS_SERVICE_SDK_JAJA_HTTPSREQUEST_12_009: [The function shall return the HTTPS response received, including the status code, body, header fields, and error reason (if any).]
    // Tests_SRS_SERVICE_SDK_JAJA_HTTPSREQUEST_12_012: [If an I/O exception occurs because of a bad response status code, the function shall attempt to flush or read the error stream so that the underlying HTTPS connection can be reused.]
    @Test
    ...
    // Tests_SRS_SERVICE_SDK_JAJA_HTTPSREQUEST_12_011: [If the client cannot connect to the server, the function shall throw an IOException.]
    @Test(expected = IOException.class)
    ...
    // Tests_SRS_SERVICE_SDK_JAJA_HTTPSREQUEST_12_013: [The function shall set the header field with the given name to the given value.]
    @Test
    ...
    // Tests_SRS_SERVICE_SDK_JAJA_HTTPSREQUEST_12_014: [The function shall set the read timeout for the request to the given value.]
    @Test
