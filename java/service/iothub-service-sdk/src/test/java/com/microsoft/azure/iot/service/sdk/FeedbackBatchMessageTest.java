...
{
    // Tests_SRS_SERVICE_SDK_JAVA_AMQPMESSAGE_12_001: [The function shall return an empty FeedbackBatch object if the input is empty or null]
    @Test
    public void json_null()
    {
        String jsonString = null;
        FeedbackBatch feedbackBatch = FeedbackBatchMessage.parseFeedbackBatch(jsonString);
    ...
    // Tests_SRS_SERVICE_SDK_JAVA_AMQPMESSAGE_12_002: [The function shall return an empty FeedbackBatch object if the content of the Data input is empty]
    // Tests_SRS_SERVICE_SDK_JAVA_AMQPMESSAGE_12_003: [The function shall remove data batch brackets if they exist]
    @Test
    ...
    // Tests_SRS_SERVICE_SDK_JAVA_AMQPMESSAGE_12_004: [The function shall throw a JsonParsingException if the parsing failed]
    ...
    // Tests_SRS_SERVICE_SDK_JAVA_AMQPMESSAGE_12_005: [The function shall parse all the Json records to the FeedbackBatch]
    // Tests_SRS_SERVICE_SDK_JAVA_AMQPMESSAGE_12_006: [The function shall copy the last record’s UTC time for batch UTC time]
    @Test
    public void testAmqpMessageJsonDataGoodCaseSuccess()
    {
        String jsonString =
                "Data{[" +
        ...
        assertEquals(feedbackBatch.getRecords().get(0).getStatusCode(), FeedbackStatusCodeEnum.success);
        ...
        assertEquals(feedbackBatch.getRecords().get(1).getStatusCode(), FeedbackStatusCodeEnum.expired);
        ...
        assertEquals(feedbackBatch.getRecords().get(2).getStatusCode(), FeedbackStatusCodeEnum.deliveryCountExceeded);
        ...
        assertEquals(feedbackBatch.getRecords().get(3).getStatusCode(), FeedbackStatusCodeEnum.unknown);
        ...
        assertEquals(feedbackBatch.getRecords().get(4).getStatusCode(), FeedbackStatusCodeEnum.rejected);
