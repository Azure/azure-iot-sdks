...
echo F | xcopy /q /y /R %build-root%\csharp\Microsoft.Azure.Devices.Client\Properties\AssemblyInfo.cs %build-root%\csharp\Microsoft.Azure.Devices.Client\Properties\Original_AssemblyInfo.cs
if %errorlevel% neq 0 exit /b %errorlevel%

echo F | xcopy /q /y /R %build-root%\csharp\Microsoft.Azure.Devices.Client.WinRT\Properties\AssemblyInfo.cs %build-root%\csharp\Microsoft.Azure.Devices.Client.WinRT\Properties\Original_AssemblyInfo.cs
if %errorlevel% neq 0 exit /b %errorlevel%

rem -- Add the Attributes for Delay-Signing to the AssemblyInfo.cs file(s)
echo [assembly: AssemblyDelaySignAttribute(true)] >> %build-root%\csharp\Microsoft.Azure.Devices.Client\Properties\AssemblyInfo.cs
echo [assembly: AssemblyKeyFileAttribute("35MSSharedLib1024.snk")] >> %build-root%\csharp\Microsoft.Azure.Devices.Client\Properties\AssemblyInfo.cs

echo [assembly: AssemblyDelaySignAttribute(true)] >> %build-root%\csharp\Microsoft.Azure.Devices.Client.WinRT\Properties\AssemblyInfo.cs
...
xcopy /q /y /R %build-root%\csharp\Microsoft.Azure.Devices.Client.WinRT\Properties\Original_AssemblyInfo.cs %build-root%\csharp\Microsoft.Azure.Devices.Client.WinRT\Properties\AssemblyInfo.cs
if %errorlevel% neq 0 exit /b %errorlevel%
